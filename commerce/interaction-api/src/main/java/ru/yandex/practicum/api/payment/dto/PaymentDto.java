...
public class PaymentDto {
    ...
    @Digits(integer = 17, fraction = 2, message = "Общая стоимость поддерживает максимум 17 цифр и 2 после запятой")
    ...
    @Digits(integer = 17, fraction = 2, message = "Стоимость доставки поддерживает максимум 17 цифр и 2 после запятой")
    ...
    @Digits(integer = 17, fraction = 2, message = "Стоимость налога поддерживает максимум 17 цифр и 2 после запятой")
    BigDecimal feeTotal;
}
